...
const AboutUsSection = () => {
  return (
    <section className="container flex items-center justify-center mt-20 mx-auto">
      <div className="w-full max-w-[1080px] flex md:flex-row flex-col items-center md:items-start justify-between">
        {/* GMaps iframe  */}
        <iframe
        ...
        />
        <div className="flex flex-col gap-y-8 flex-1 max-w-[600px]">
          <div>
